...
class Biblioteca {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Inserire la quantità di libri presenti in biblioteca: ");
        do {
        ...
        for (i = 0; i <= n - 1; i++) {
            System.out.println("Inserisci il titolo di un libro della biblioteca: ");
            biblioteca[i] = Integer.parseInt(in.nextLine());
        }
        do {
            scelta = leggiComando();
            if (scelta == 1) {
            ...
            if (scelta == 3) {
                ...
                libroRichiesto = Integer.parseInt(in.nextLine());
            ...
            if (scelta == 4) {
                ...
                do {
                    libroRestituito = Integer.parseInt(in.nextLine());
